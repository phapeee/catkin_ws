...
set(MSG_I_FLAGS "-Ikeyboard:/home/ubuntu/catkin_ws/src/ros-keyboard/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ubuntu/catkin_ws/src/ros-keyboard/msg/Key.msg" NAME_WE)
add_custom_target(_keyboard_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "keyboard" "/home/ubuntu/catkin_ws/src/ros-keyboard/msg/Key.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(keyboard
  "/home/ubuntu/catkin_ws/src/ros-keyboard/msg/Key.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/keyboard)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/keyboard\")")
  # install generated code
  install(
